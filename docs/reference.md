...
- <a id="properties/Unit_dictionary"></a>**`Unit_dictionary`** *(array)*: Benchling unit types and the units that belong to them. Length must be at least 0. Items must be unique.
  - <a id="properties/Unit_dictionary/items"></a>**Items** *(object)*: A dimensional unit type (e.g., Mass, Volume, Mass concentration) and its units.
    ...
    - <a id="properties/Unit_dictionary/items/properties/Dimensional%20terms%20%28do%20not%20hand-edit%29"></a>**`Dimensional terms (do not hand-edit)`** *(array)*: Opaque, Benchling-internal dimensional signature for this unit type (e.g., MASS^1, LENGTH^-3). This is not shown anywhere in the Benchling UI, is not reliably derivable from Formula (Benchling's own data is not always internally consistent here), and has no meaningful hand-authored value. Populated verbatim by export tooling; carried through unmodified on import. Omit for hand-authored unit types (import will proceed without it).
      - <a id="properties/Unit_dictionary/items/properties/Dimensional%20terms%20%28do%20not%20hand-edit%29/items"></a>**Items** *(object)*
        - <a id="properties/Unit_dictionary/items/properties/Dimensional%20terms%20%28do%20not%20hand-edit%29/items/properties/Dimension"></a>**`Dimension`** *(string, required)*: Benchling's dimension token (e.g., MASS, LENGTH, TIME, AMOUNT), verbatim from the export.
        - <a id="properties/Unit_dictionary/items/properties/Dimensional%20terms%20%28do%20not%20hand-edit%29/items/properties/Exponent"></a>**`Exponent`** *(integer, required)*
...
- <a id="properties/Entity_schemas"></a>**`Entity_schemas`** *(array)*: Entity schemas (e.g., Custom Entity, DNA Sequence, etc.). Length must be at least 0. Items must be unique.
  - <a id="properties/Entity_schemas/items"></a>**Items** *(object)*: Complete description of the entity schema. Some attributes only apply to certain schema types.
    ...
    - <a id="properties/Entity_schemas/items/properties/Icon"></a>**`Icon`** *(string)*: Icon for the schema. Matches benchling names without any translation. Must be one of: "antibody", "bacteria", "basic_folder_item", "box", "cell-line", "compound", "entry", "fridge", "linear", "material", "mixture", "mortar-pestle", "mouse", "oligo", "oligo-v2", "plant", "plasmid", "plate", "primer_pair", "protein", "recipe", "rna_sequence", "sample-slide", "sequence", "small-molecule", "small-molecule-beaker", "solution", "vial", "chromatography", "human", or "worm".
    ...
    - <a id="properties/Entity_schemas/items/properties/Container%20name%20template"></a>**`Container name template`** *(array)*: Template for naming containers created for entities of this schema. Optional; omit when the entity has no container naming template. Length must be at least 0.
      - <a id="properties/Entity_schemas/items/properties/Container%20name%20template/items"></a>**Items** *(object)*: Ordered parts of a container name template. Text and Separator require Definition (literal string). Field requires Definition (entity field display name). All other Types omit Definition.
        - <a id="properties/Entity_schemas/items/properties/Container%20name%20template/items/properties/Type"></a>**`Type`** *(string, required)*: The type of container name component. Must be one of: "Text", "Separator", "Field", "Contained entity name", "Sample lot number", "Registry ID number", "Registry ID number (base 26)", "Barcode", "Barcode number", "Concentration value", "Concentration units", "Fill date", "Fill year", "Parent storable barcode", "Parent storable name", "Position", "Project", "Quantity value", "Quantity units", or "Restriction status".
        - <a id="properties/Entity_schemas/items/properties/Container%20name%20template/items/properties/Definition"></a>**`Definition`** *(string)*: Literal text for Text/Separator, or the entity field display name for Field. Omitted for all other Types.
    ...
    - <a id="properties/Entity_schemas/items/properties/Fields"></a>**`Fields`** *(array)*: Metadata fields. Length must be at least 0. Items must be unique.
      - <a id="properties/Entity_schemas/items/properties/Fields/items"></a>**Items** *(object)*: Metadata field definitions.
        ...
        - <a id="properties/Entity_schemas/items/properties/Fields/items/properties/Type"></a>**`Type`** *(string, required)*: Data type for the field. Must be one of: "Date", "Datetime", "Decimal", "Integer", "Long text", "Dropdown", "Text", "Boolean", "Attachment", "Entry", "Entity", "Category", "Part", "Inventory", "Translation", "ft_assay_run_link", "ft_assay_request_link", "Batch", or "Transcription".
        - <a id="properties/Entity_schemas/items/properties/Fields/items/properties/Definition"></a>**`Definition`**: Name of target object if Type is one of the link types or Dropdown. For Part / Translation / Transcription (biointelligent links), Definition must be a concrete entity schema name (no Any … generics): Part targets same-modality DNA/RNA Sequence schemas; Translation targets an AA Sequence schema; Transcription targets an RNA Sequence schema.
          - **Any of**
  ...
  - <a id="properties/Fieldset_schemas/items"></a>**Items** *(object)*: Complete description of the fieldset schema.
    ...
    - <a id="properties/Fieldset_schemas/items/properties/Fields"></a>**`Fields`** *(array)*: Metadata fields. Length must be at least 0. Items must be unique.
      - <a id="properties/Fieldset_schemas/items/properties/Fields/items"></a>**Items** *(object)*: Metadata field definitions.
        ...
        - <a id="properties/Fieldset_schemas/items/properties/Fields/items/properties/Type"></a>**`Type`** *(string, required)*: Data type for the field. Must be one of: "Date", "Datetime", "Decimal", "Integer", "Long text", "Dropdown", "Text", "Attachment", "Entry", "Entity", "Part", "Inventory", "Translation", "ft_assay_run_link", or "ft_assay_request_link".
        - <a id="properties/Fieldset_schemas/items/properties/Fields/items/properties/Definition"></a>**`Definition`**: Name of target object if Type is one of the link types or Dropdown.
          - **Any of**
  ...
  - <a id="properties/Result_schemas/items"></a>**Items** *(object)*: Complete description of the result schema.
    ...
    - <a id="properties/Result_schemas/items/properties/Fields"></a>**`Fields`** *(array)*: Metadata fields. Length must be at least 0. Items must be unique.
      - <a id="properties/Result_schemas/items/properties/Fields/items"></a>**Items** *(object)*: Metadata field definitions.
        ...
        - <a id="properties/Result_schemas/items/properties/Fields/items/properties/Type"></a>**`Type`** *(string, required)*: Data type for the field. Must be one of: "Date", "Datetime", "Decimal", "Integer", "Long text", "Dropdown", "Text", "Attachment", "Entry", "Entity", "Category", "Part", "Inventory", "JSON", "Boolean", "Result", "ft_assay_request_link", "Batch", or "Run".
        - <a id="properties/Result_schemas/items/properties/Fields/items/properties/Definition"></a>**`Definition`**: Name of target object if Type is a one of the link types or Dropdown. May optionally point to a dropdown if type is Integer or Decimal. For Result, use the target Result schema name, or 'Any result' for an unrestricted link.
          - **Any of**
  ...
  - <a id="properties/Run_schemas/items"></a>**Items** *(object)*: Complete description of the run schema.
    ...
    - <a id="properties/Run_schemas/items/properties/Fields"></a>**`Fields`** *(array)*: Metadata fields. Length must be at least 0. Items must be unique.
      - <a id="properties/Run_schemas/items/properties/Fields/items"></a>**Items** *(object)*: Metadata field definitions.
        ...
        - <a id="properties/Run_schemas/items/properties/Fields/items/properties/Type"></a>**`Type`** *(string, required)*: Data type for the field. Must be one of: "Date", "Datetime", "Decimal", "Integer", "Long text", "Dropdown", "Text", "Attachment", "Entry", "Entity", "Inventory", "JSON", "Boolean", "Run", or "Result".
        - <a id="properties/Run_schemas/items/properties/Fields/items/properties/Definition"></a>**`Definition`**: Name of target object if Type is a link type (Entity, Inventory, Run, Result) or Dropdown. For Result, use the target Result schema name, or 'Any result' for an unrestricted link.
          - **Any of**
            - <a id="properties/Run_schemas/items/properties/Fields/items/properties/Definition/anyOf/0"></a>*string*: Must be one of: "Any Entity", "Custom Entity", "AA Sequence", "DNA Sequence", "Molecule", "Mixture", "Any inventory", or "Any result".
...
- <a id="properties/Template_collections"></a>**`Template_collections`** *(array)*: Template collections. Length must be at least 0.
  - <a id="properties/Template_collections/items"></a>**Items** *(object)*: Complete description of the template collection.
    - <a id="properties/Template_collections/items/properties/Name"></a>**`Name`** *(string, required)*: Template collection name. Must match pattern: `\S` ([Test](https://regexr.com/?expression=%5CS)).
...
- <a id="properties/Templates"></a>**`Templates`** *(array)*: Templates. Length must be at least 0.
  - <a id="properties/Templates/items"></a>**Items** *(object)*: Description of an entry template.
    - <a id="properties/Templates/items/properties/Name"></a>**`Name`** *(string, required)*: Template name. Must match pattern: `\S` ([Test](https://regexr.com/?expression=%5CS)).
    - <a id="properties/Templates/items/properties/Description"></a>**`Description`** *(string)*: Description of the template.
    - <a id="properties/Templates/items/properties/Collection"></a>**`Collection`** *(string, required)*: Name of the template collection that the template belongs to. Must match pattern: `\S` ([Test](https://regexr.com/?expression=%5CS)).
    - <a id="properties/Templates/items/properties/Schema"></a>**`Schema`** *(string)*: Name of the entry schema attached to the template. Must match pattern: `\S` ([Test](https://regexr.com/?expression=%5CS)).
...
- <a id="properties/Sub_templates"></a>**`Sub_templates`** *(array)*: Sub templates. Length must be at least 0.
  - <a id="properties/Sub_templates/items"></a>**Items** *(object)*: Description of a sub-template.
    - <a id="properties/Sub_templates/items/properties/Name"></a>**`Name`** *(string, required)*: Sub-template name. Must match pattern: `\S` ([Test](https://regexr.com/?expression=%5CS)).
    - <a id="properties/Sub_templates/items/properties/Description"></a>**`Description`** *(string)*: Description of the sub-template.
    - <a id="properties/Sub_templates/items/properties/Collection"></a>**`Collection`** *(string, required)*: Name of the template collection that the sub-template belongs to. Must match pattern: `\S` ([Test](https://regexr.com/?expression=%5CS)).
